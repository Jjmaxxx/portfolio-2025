    ...
    <section ref={sectionRef} id="about" className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="scroll-animate text-5xl font-bold mb-8 opacity-0 transform translate-y-10">
              About Me
            </h2>
            <p className="scroll-animate text-lg text-gray-300 mb-6 opacity-0 transform translate-y-10">
              ...
              that blend functionality with beautiful design. With over 5 years
            ...
            <p className="scroll-animate text-lg text-gray-300 mb-8 opacity-0 transform translate-y-10">
              ...
              has evolved into a deep passion for crafting solutions that make a
